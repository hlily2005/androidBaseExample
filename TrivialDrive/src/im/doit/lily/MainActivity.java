...
import im.doit.lily.util.IabHelper;
import im.doit.lily.util.IabResult;
import im.doit.lily.util.Inventory;
import im.doit.lily.util.Purchase;
...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 */
		String base64EncodedPublicKey = "";
